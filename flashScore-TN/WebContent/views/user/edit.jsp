...
<!--Main Layout-->
	<div class="container">
		...
		<form role="form" method="post" action="${pageContext.request.contextPath}/admin?action=update">
			<input type="hidden" name="userid" value="${userEdit.userid}"/>
			<div class="form-group">
				<label for="login">Login</label>
				<input type="text" class="form-control" name="login" id="login" placeholder="Insert login" required value="${userEdit.name}"/>
			</div>
			<!-- Password -->
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="type" id="type" placeholder="Insert type" required value="${userEdit.type }"/>
			</div>
